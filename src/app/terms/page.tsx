    ...
    <div className="container max-w-4xl mx-auto py-12 md:py-20 px-4 md:px-6">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p>
            If you have any questions about these Terms, please contact us at: <a href="mailto:teamcyberwall@gmail.com" className="text-primary hover:underline">terms@cyberwall.com</a>
          </p>
        </div>
      </div>
    </div>
